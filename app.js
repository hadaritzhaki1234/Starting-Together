...
function _getAnnDefaults(){
  return[
    {id:1,title:'מועדי בחינות אמצע פורסמו',body:'לוח מועדי הבחינות האמצע לכל הקורסים פורסם. אנא בדקו בפורטל הסטודנטים את מועדי הבחינות והמיקומים הספציפיים שלכם.',date:'18 מאי 2026',views:0,viewedBy:[]},
    {id:2,title:'מפגשי למידה קבוצתיים השבוע',body:'הצטרפו אלינו למפגשי למידה משותפים בספרייה כל ערב בין השעות 18:00-20:00. כל הסטודנטים מוזמנים!',date:'28 אפריל 2026',views:0,viewedBy:[]},
    {id:3,title:'סדנת קריירה: בניית קורות חיים',body:'למדו כיצד ליצור קורות חיים מרשימים. הסדנה מתוכננת ליום שני הבא בשעה 15:00 בחדר 204.',date:'10 אפריל 2026',views:0,viewedBy:[]},
    {id:4,title:'תזכורת: שעות קבלה שבועיות',body:'שעות הקבלה שלי הן בכל יום שלישי בין 14:00-16:00. ניתן לקבוע תור מראש. אשמח לראות אתכם!',date:'22 מרץ 2026',views:0,viewedBy:[]},
    {id:5,title:'ברוכים הבאים לסמסטר! 🎉',body:'שלום לכולם! אנחנו שמחים לקבל אתכם לסמסטר החדש. אנא קראו את כל המידע החשוב בלוח הבקרה ואל תהססו לפנות אלינו בכל שאלה.',date:'1 מרץ 2026',views:0,viewedBy:[]},
  ];
}
...
const ANNS_V=4;  // bump when ann data model changes
